                              ...
                              onPressed: () async {
                                await PastbookingRecord.collection
                                    ...
                                    .set(createPastbookingRecordData(
                                      doctorsname:
                                          optionsBookingsRecord.doctorsname,
                                      clientsname:
                                          optionsBookingsRecord.clientsname,
                                      doctorsimage:
                                          optionsBookingsRecord.doctorsimage,
                                      doctorsspecialty: optionsBookingsRecord
                                          .doctorsspecialty,
                                      doctorsrating:
                                          optionsBookingsRecord.doctorsrating,
                                      orderDate:
                                          optionsBookingsRecord.orderDate,
                                      orderId: optionsBookingsRecord.orderId,
                                      clientsimage:
                                          optionsBookingsRecord.clientsimage,
                                    ));
