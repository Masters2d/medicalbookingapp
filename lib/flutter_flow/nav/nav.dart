...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'doctorsdetailpage',
          path: '/doctorsdetailpage',
          builder: (context, params) => DoctorsdetailpageWidget(
            populardoctorsRef: params.getParam('populardoctorsRef',
                ParamType.DocumentReference, false, ['populardoctors']),
          ),
        ),
        FFRoute(
          name: 'mybookings',
        ...
        FFRoute(
          name: 'doctorsettings',
          path: '/doctorsettings',
          builder: (context, params) => DoctorsettingsWidget(),
        ),
        FFRoute(
          name: 'adminpanel',
          path: '/adminpanel',
